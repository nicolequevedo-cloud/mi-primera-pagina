...
# Ejercicio 4 y 5
en este paso juntamos los anteriores codigos y le ponemos la funcion left que lo hace lo que ya esta hecho pero en forma de cadena para que la tortuga baje en forma de escalerita con los siguientes codigos:
import turtle
t = turtle.Turtle()
t.forward(90)
t.right(90)          # Gira 90 grados a la derecha
